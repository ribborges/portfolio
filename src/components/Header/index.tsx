...
import { AnimatedGridBackground } from "./AnimBackground";
			...
			<div className="md:flex-1">
				<div className={alfaSlabOne.className}>
					<span className="text-lg md:text-xl lg:text-2xl">
						<Translator path="home.greeting" />
					</span>
					<H1 className="justify-start flex-wrap text-xl md:text-2xl lg:text-3xl">
						<span>
				...
				<div className="flex flex-wrap justify-center md:justify-start gap-2">
					<ButtonLink href="mailto:contato@richardborges.dev">
						<EnvelopeFill />
						<span className="hidden md:block">
							<Translator path="home.email" />
						</span>
					</ButtonLink>
					<ButtonLink href="https://wa.me/5511942347830">
						<Whatsapp />
						<span className="hidden md:block">
							<Translator path="home.whatsapp" />
						</span>
					</ButtonLink>
					<ButtonLink href="https://linkedin.com/in/ribborges">
						<Linkedin />
						<span className="hidden md:block">
							<Translator path="home.linkedin" />
						</span>
					</ButtonLink>
					<ButtonLink href="https://github.com/ribborges">
						<Github />
						<span className="hidden md:block">
							<Translator path="home.github" />
						</span>
					</ButtonLink>
					<ButtonLink href="/static/docs/cv-richard-borges.pdf">
						<FileEarmarkPersonFill />
						<span className="hidden md:block">
							<Translator path="home.cv" />
						</span>
					</ButtonLink>
				</div>
			</div>
