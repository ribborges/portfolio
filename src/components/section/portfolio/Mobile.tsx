    ...
    return (
        <Grid>
            <Card
                ...
                title={props.lang?.portfolio[2].project[0].title}
                text={props.lang?.portfolio[2].project[0].text}
            >
                <ButtonLink href="/fisio-home" target="_self"><i className="bi bi-three-dots-vertical" /> {props.lang?.portfolio[2].project[0].btn[0]}</ButtonLink>
            </Card>

            <Card
                thumb="/static/img/projects/catFact.png"
                title={props.lang?.portfolio[2].project[1].title}
                text={props.lang?.portfolio[2].project[1].text}
            >
                <ButtonLink href="https://github.com/ribborges/cat-fact-app"><i className="bi bi-github" /> {props.lang?.portfolio[2].project[1].btn[0]}</ButtonLink>
            </Card>
